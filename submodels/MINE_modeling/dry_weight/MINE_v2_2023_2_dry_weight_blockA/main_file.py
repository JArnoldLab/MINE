...
if option_wf == 1:
    ...
    if option_wf == 2:
        ...
        mg.get_mine_score_final_accessions(file_accessions, labels, data_values, beta_matrix_star, gamma_vector_matrix_avg, number_datapoints, s_cut_evals, number_new_experiments, name_simulation, "_score_Nc3" , criteria_option)
    elif option_wf == 4:
        ...
        mg.get_mine_score_final_accessions(file_accessions, labels, data_values, beta_matrix_star, gamma_vector_matrix_avg, number_datapoints, s_cut_evals, number_new_experiments, name_simulation, "_score_greedy" , criteria_option)
    elif option_wf == 5:
        ...
        mg.get_mine_score_final_accessions(file_accessions, labels, data_values, beta_matrix_star, gamma_vector_matrix_avg, number_datapoints, s_cut_evals, number_new_experiments, name_simulation, "_score_Nc3_Nc2" , criteria_option)
    elif option_wf == 6:
