...
matrix_steps = np.loadtxt(name_simulation + "/ham_test_steps")
...
plt.figure()
plt.plot(matrix_steps)
plt.xlabel("Steps")
plt.ylabel("Hamiltonian")
plt.title("Steps from sweeps 750000 to 800000")
plt.savefig(name_simulation + "/steps")
plt.close("all")
